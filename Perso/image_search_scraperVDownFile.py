...
py image_search_scraper.py --search "object" --nb_images X --directory "dataset/Download"
py image_search_scraper.py --search "object1","object2",...,"object5" --nb_images X --directory "dataset/Download"
...
def main(args):
    if(len(args) > 1):
        ...
        parser.add_argument("-d", "--directory", default="dataset/", type=str, help="Save directory")
        ...
        max_images = 100
        first_image_index = 0
        save_directory = "dataset/download"
